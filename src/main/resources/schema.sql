...
CREATE TABLE appuser(
    ...
    login_attempt INTEGER NOT NULL COMMENT 'The number of failed attempts to login to this account.',
    last_login_attempt TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'The timestamp of the last failed attempt to login to this account.',
