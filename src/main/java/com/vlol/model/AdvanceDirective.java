...
public class AdvanceDirective implements Serializable {
  ...
  /**
   * Override the toString() method so advanceDirective names will be shown in the form. And
   * equals() and hashCode() must be overridden so Spring MVC and Thymeleaf will show the check
   * marks correctly when the form is in edit mode. Thanks to
