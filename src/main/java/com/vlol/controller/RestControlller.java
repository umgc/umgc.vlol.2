...
public class RestControlller {
    ...
    @Autowired
    private AdvanceDirectiveService advanceDirective;
    ...
    @ResponseBody
    public void getAdvanceDirective(HttpServletResponse response, @PathVariable(name = "advanceDirectiveId") Long advanceDirectiveId) throws IOException {
        try{
