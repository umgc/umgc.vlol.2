...
public class UserConditionController {
  ...
  @RequestMapping(
      value = {"/user/save-condition", "/user/save-condition/{id}"},
      method = RequestMethod.POST)
  public String saveCondition(
      @PathVariable(name = "id", required = false) Long id,
      @Valid UserCondition condition,
  ...
  @RequestMapping(
      value = {"/user/edit-condition/{conditionId}", "/user/edit-condition/{id}/{conditionId}"})
  public ModelAndView viewEditConditionPage(
      @PathVariable(name = "id", required = false) Long id,
    ...
    for (UserCondition condition : user.getConditions())
      if (condition.getConditionId().equals(conditionId)) found = true;
  ...
  @RequestMapping(
      value = {"/user/delete-condition/{conditionId}", "/user/delete-condition/{id}/{conditionId}"})
