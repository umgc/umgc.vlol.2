...
public class UserVaccineController {
  ...
  @Autowired private UserVaccineService userVaccineService;
  ...
  @RequestMapping(
      value = {"/user/save-vaccine", "/user/save-vaccine/{id}"},
      method = RequestMethod.POST)
  public String saveVaccine(
      @PathVariable(name = "id", required = false) Long id,
      @Valid UserVaccine vaccine,
  ...
  public ModelAndView viewAddVaccinePage(
  ...
  public ModelAndView viewEditVaccinePage(
      @PathVariable(name = "id", required = false) Long id,
    ...
    for (UserVaccine vaccine : user.getVaccines())
      if (vaccine.getVaccineId().equals(vaccineId)) found = true;
  ...
  @RequestMapping(
      value = {"/user/delete-vaccine/{vaccineId}", "/user/delete-vaccine/{id}/{vaccineId}"})
